...
case "$LEAN_WASM_RUNTIME_PROFILE" in
  browser)
    ...
    LEAN_WASM_LINK_SPIKE_DIR="$LEAN_WASM_PROJECT_ROOT/build/lean-link-spike"
    ;;
  threaded)
...
LEAN_WASM_RUNTIME_BUILD_ID="$LEAN_WASM_LEAN_COMMIT-$LEAN_WASM_PATCH_SET_SHA-$LEAN_WASM_RUNTIME_PROFILE"
