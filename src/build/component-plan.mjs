...
export const prepareComponentBuildPlan = async ({ projectRoot, engineRoot, targets = [], analyze = analyzeLeanProject, signal = undefined, lakeSnapshot = undefined }) => {
	...
	for(const target of selected)
		assertExportConfigurationCapabilities(record.configuration, { target, fields: target === "npm" ? ["modules", "exports", "generators", "specializations"] : ["modules", "exports"], targetFields: target === "npm" ? ["name", "version"] : [] });
