...
const validateLinkManifest = ({ manifest, compilationPlan }) => {
	...
	if(compilationPlan.document.schemaVersion === 3 && manifest.generatedSourcesSha256 !== compilationPlan.document.source.generatedSourcesSha256) fail("side-module-plan-drift", "Generated public roots differ from the elaborated source identity");
