...
/**
 * Reports onboarding acceptance failures with stable machine-readable codes and structured diagnostic context.
 */
export class OnboardingAcceptanceError extends Error
{
	/**
   * Initializes the error used to report onboarding acceptance failures, preserving its code, message, and diagnostic context.
   *
...
/**
 * Validates onboarding manifest against its closed contract before it enters the documented consumer acceptance workflow.
 *
...
/**
 * Loads onboarding manifest, verifies its structure and identity, and returns it to the documented consumer acceptance workflow.
 *
...
/**
 * Runs onboarding fixture matrix and returns a structured result suitable for the documented consumer acceptance workflow.
 *
 * @param root0 - Named inputs and dependency overrides used to run onboarding fixture matrix.
 * @param root0.fixtureRoot - Filesystem root containing the fixture.
