...
const profileManifest = Object.freeze({
	contract: Object.freeze([
		...
		, "owned-aggregate-contract"
		, "owned-aggregate-model"
		, "owned-aggregate-metadata"
		...
		, "python-structured-callable-contract"
		, "python-recursive-callable-contract"
		, "rust-recursive-callable-contract"
		, "ruby-recursive-callable-contract"
		, "python-structured-callable-evidence"
		...
		, "ruby-structured-callable-contract"
		, "ruby-structured-callable-evidence"
		...
		, "perl-structured-callable-contract"
		, "perl-recursive-callable-contract"
		, "perl-structured-callable-evidence"
		, "perl-list-contract"
		...
		, "rust-structured-callable-contract"
		, "rust-structured-callable-evidence"
		...
		, "jvm-structured-callable-contract"
		, "jvm-structured-callable-evidence"
		, "jvm-recursive-callable-contract"
		, "jvm-recursive-callable-evidence"
		...
		, "php-structured-callable-contract"
		, "php-structured-callable-evidence"
		, "php-recursive-callable-contract"
		, "php-recursive-callable-evidence"
		, "php-wasm-recursive-callable-contract"
		, "php-wasm-recursive-callable-evidence"
		, "php-wasm-recursive-callable-wrappers"
		...
		, "php-wasm-structured-callable-contract"
		, "php-wasm-structured-callable-evidence"
		...
		, "wit-recursive-callable-faults"
		, "wit-recursive-callable-package"
		, "wit-recursive-callable-evidence"
		, "wit-structured-callable-contract"
		, "wit-structured-callable-evidence"
		, "native-callback-alias-contract"
		, "wit-alias-contract"
		, "wit-alias-evidence"
		...
		, "native-recursive-callable-model"
		, "native-recursive-callable-compile"
		, "owned-aggregate-native"
		, "owned-native-values"
		, "owned-native-scalars"
	...
	, native: Object.freeze([
		...
		, "jvm-callables"
		, "jvm-structured-callables"
		, "jvm-recursive-callables"
		, "jvm-compounds"
		, "jvm-lists"
		, "jvm-aliases"
		, "jvm-variants"
		...
		, "jvm-value-equality"
		, "php-callables"
		, "php-structured-callables"
		, "php-recursive-callables"
		, "php-compounds"
		, "php-collections"
		, "php-collection-conversions"
		, "php-value-equality"
		, "php-wasm-callables"
		, "php-wasm-structured-callables"
		, "php-wasm-structured-callable-zend"
		, "php-wasm-recursive-callable-generated"
		, "php-wasm-recursive-callable-packages"
		, "wit-structured-callables"
		, "wit-structured-aliases"
		, "wit-structured-documentation"
		, "wit-structured-callable-faults"
		, "php-wasm-compounds"
	...
	, component: Object.freeze([
		...
		, "component-scalars"
		, "component-callables"
		, "component-structured-callables"
		, "component-structured-callable-wasm"
		, "component-arrays"
		, "component-records"
		, "component-compounds"
		, "component-lists"
		...
		, "c-variants"
		, "perl-callables"
		, "perl-structured-callables"
		, "perl-recursive-callables"
		, "perl-compounds"
		, "perl-lists"
		, "perl-collections"
		, "perl-aliases"
		...
		, "php-lists"
		, "c-callables"
		, "closure-thread-installed"
		, "c-structured-callables"
		, "c-recursive-callable-package"
		, "c-family-recursive-documentation"
		, "native-recursive-callable-evidence"
		, "closure-thread-evidence"
		, "php-ci-regression-evidence"
		, "python-recursive-callable-evidence"
		, "rust-recursive-callable-evidence"
		, "ruby-recursive-callable-evidence"
		, "perl-recursive-callable-evidence"
		, "wit-callables"
		, "wit-compounds"
		...
		, "python-callables"
		, "python-structured-callables"
		, "python-recursive-callables"
		, "rust-recursive-callables"
		, "ruby-recursive-callables"
		, "python-compounds"
		, "python-lists"
		, "python-collections"
		...
		, "cpp-recursive-callable-package"
