...
/**
 * Reports usability gate failures with stable machine-readable codes and structured diagnostic context.
 */
export class UsabilityGateError extends Error
{
	/**
   * Initializes the error used to report usability gate failures, preserving its code, message, and diagnostic context.
   *
...
/**
 * Validates usability sessions against its closed contract before it enters the documented consumer acceptance workflow.
 *
...
/**
 * Loads usability sessions, verifies its structure and identity, and returns it to the documented consumer acceptance workflow.
 *
...
/**
 * Evaluates required user roles and recorded sessions against clean-checkout, packaging, diagnostics, and reproducibility criteria.
 *
 * @param document - Validated usability-session document to score against the acceptance gate.
 */
