...
{
	/**
   * Initializes the error used to report PHP conformance failures, preserving its code, message, and diagnostic context.
   *
...
/**
 * Compares PHP conformance results and returns bounded diagnostics for every material difference.
 *
 * @param root0 - Named inputs and dependency overrides used to compare PHP conformance results.
 * @param root0.corpus - Closed conformance corpus whose cases are executed through both PHP transports.
 * @param root0.native - Native PHP transport results compared case-for-case with the WebAssembly transport.
 * @param root0.phpWasm - PHP WebAssembly transport results compared with the native PHP transport.
 */
...
/**
 * Generates PHP conformance corpus from validated semantic input without introducing behavior outside the generated native-language binding pipeline.
 *
