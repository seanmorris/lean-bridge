...
/**
 * Reports PHP projection failures with stable machine-readable codes and structured diagnostic context.
 */
export class PhpProjectionError extends Error
{
	/**
   * Initializes the error used to report PHP projection failures, preserving its code, message, and diagnostic context.
   *
...
/**
 * Compiles PHP projection into the explicit representation consumed by the generated native-language binding pipeline.
 *
...
/**
 * Compiles PHP transport manifest into the explicit representation consumed by the generated native-language binding pipeline.
 *
 * @param projection - Compiled PHP projection whose transport capabilities are summarized in the manifest.
 * @param profile - Named runtime, graph, transport, or measurement profile selecting the closed behavior to execute.
 */
...
/**
 * Rejects inputs when PHP transport supported would violate an invariant owned by the generated native-language binding pipeline.
 *
