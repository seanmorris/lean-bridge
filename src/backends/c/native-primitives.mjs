...
export const generateNativePrimitiveC = (model, receipt) => {
	const surface = compilePrimitiveCSurface(model.bindingIr, { wordBits: model.pointerBits, callables: true, compounds: true, lists: true, variants: true }), p = surface.prefix, macro = p.toUpperCase();
