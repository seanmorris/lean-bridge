...
const validateWorkload = (workload, path) => {
  ...
  exactKeys(workload.distribution, [
    "kind", "coordinateMinimum", "coordinateMaximum", "clusterCount", "clusterRadius",
...
const makeInitialPoints = (workload, random) => {
  const centers = Array.from({ length: workload.distribution.clusterCount }, () =>
    Array.from({ length: workload.dimensions }, () =>
      randomInteger(
        random,
        workload.distribution.coordinateMinimum,
        workload.distribution.coordinateMaximum,
