...
const validateEnvironment = (environment, index) => {
  ...
  closedObject(environment, path, [
    "id", "eligibility", "operatingSystem", "hardware", "runtimes", "constraints", "limitations",
  ]);
  ...
  closedObject(environment.constraints, `${path}.constraints`, [
    "exclusiveRunner", "cpuGovernor", "maximumLoadAveragePerCpu", "swapActivity", "networkDuringTimedRegions",
  ]);
...
export const validatePerformanceMethodology = methodology => {
  closedObject(methodology, "methodology", [
    ...
    "identityInputs", "execution", "sampling", "statistics", "memory", "noise", "reporting",
  ]);
  ...
  closedObject(methodology.execution, "execution", [
    "sourceState", "buildIsolation", "targetProfiles", "artifactBuildTiming", "processModel",
  ...
  closedObject(methodology.sampling, "sampling", [
    "validForks", "maximumInvalidForks", "warmup", "firstCall", "steadyStateSamples",
  ...
  closedObject(methodology.statistics, "statistics", [
    "headline", "requiredDistribution", "confidenceLevel", "bootstrapResamples", "bootstrapUnit",
  ...
  closedObject(methodology.memory, "memory", [
    "authoritative", "supplemental", "explicitGc", "finalization", "wasmGrowth", "retainedState",
  ]);
...
export const inspectPerformanceEnvironment = (methodology, observation) => {
  ...
  closedObject(observation.constraints, "observation.constraints", [
    "exclusiveRunner", "cpuGovernor", "loadAveragePerCpu", "swapInputOutputDelta", "networkDuringTimedRegions",
  ]);
...
const osRelease = async () => Object.fromEntries((await readFile("/etc/os-release", "utf8"))
  .split("\n")
