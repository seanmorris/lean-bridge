...
export const validatePerformanceEvidenceBundle = manifest => {
  exactKeys(manifest, [
    "schemaVersion", "kind", "identity", "source", "status", "report", "summary", "validation",
    "inputs", "contracts", "artifacts", "measurements", "claims", "index",
...
const auditReport = report => {
  exactKeys(report, [
    "schemaVersion", "kind", "recordedAt", "accepted", "informational", "source", "workflow", "toolchain",
    "identities", "build", "jobs", "measurements", "validation", "policy", "artifact", "limitations",
  ], "performance report");
