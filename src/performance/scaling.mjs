/**
 * Implements the scaling module in the performance subsystem.
 *
 * @file
 */
...
/**
 * Runs scaling profile and returns a structured result suitable for the reproducible performance evidence pipeline.
 *
 * @param root0 - Named inputs and dependency overrides used to run scaling profile.
 * @param root0.count - Number of items expected by the operation.
...
/**
 * Runs scaling suite and returns a structured result suitable for the reproducible performance evidence pipeline.
 *
 * @param root0 - Named inputs and dependency overrides used to run scaling suite.
 * @param root0.counts - Requested library-count tiers used to measure scaling behavior.
