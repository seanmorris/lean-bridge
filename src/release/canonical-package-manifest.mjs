...
/**
 * Reports canonical package manifest failures with stable machine-readable codes and structured diagnostic context.
 */
export class CanonicalPackageManifestError extends Error
{
	/**
   * Initializes the error used to report canonical package manifest failures, preserving its code, message, and diagnostic context.
   *
...
/**
 * Validates canonical package manifest against its closed contract before it enters the deterministic release and independent-verification pipeline.
 *
...
/**
 * Parses canonical package manifest and validates the resulting closed representation before returning it to the deterministic release and independent-verification pipeline.
 *
...
/**
 * Serializes canonical package manifest as deterministic, newline-terminated JSON for the deterministic release and independent-verification pipeline.
 *
 * @param manifest - Domain manifest whose schema, closed fields, and recorded identities are validated or serialized.
 */
...
/**
 * Computes a stable content identity for canonical package manifest so the deterministic release and independent-verification pipeline can reject drift.
 *
 * @param manifest - Domain manifest whose schema, closed fields, and recorded identities are validated or serialized.
 */
