...
export const packageOrdinaryNuget = async ({ working, dotnetRoot, nativeRoot, runtimeRoot, adapterRoot, leanPrefix, settings = {}, glibcMinimumVersion }) => {
	...
	for(const [path, contents] of Object.entries((model.copiedGraph ? (model.copiedGraph.callbacks ? generateCallableDotnetGraphPackage : generateCopiedDotnetGraphPackage) : generateCopiedDotnetPackage)(model.bindingIr, evidence)))
