...
/**
 * Builds a sorted ZIP with fixed DOS timestamps, canonical UTF-8 names, deterministic compression, and a stable central directory.
 *
 * @param root0 - Named inputs and dependency overrides used to create deterministic zip.
