...
/**
 * Builds universal release bundle from validated inputs with deterministic output suitable for the deterministic release and independent-verification pipeline.
 *
 * @param root0 - Named inputs and dependency overrides used to build universal release bundle.
 * @param root0.projectRoot - Filesystem root containing the project.
 * @param root0.coreRoot - Filesystem root containing the core.
 * @param root0.nativeRoot - Filesystem root containing the native.
 * @param root0.managedRoot - Filesystem root containing the managed.
 * @param root0.wasiRoot - Filesystem root containing the WASI.
 ...
 * @param root0.sourceDateEpoch - Unix timestamp applied to archive entries to make package bytes reproducible.
...
/**
 * Lists bundle files in deterministic order for the deterministic release and independent-verification pipeline.
 *
