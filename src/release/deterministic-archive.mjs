...
/**
 * Archives a sorted file tree with normalized modes, fixed timestamps, deterministic tar headers, and reproducible gzip metadata.
 *
 * @param root0 - Named inputs and dependency overrides used to create deterministic tar gz.
 * @param root0.directory - Filesystem directory containing the inputs to process.
 * @param root0.archiveRoot - Filesystem root containing the archive.
