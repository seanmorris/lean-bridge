...
The [signed Nix package publishing guide](../docs/publish/nix.md) covers signing and distributing approved output closures. [Prepared-release consumption](../docs/consume/receive-package.md#install-from-a-signed-nix-cache) covers consumer trust and substitution checks. Nix cache signatures and Lean Bridge's signed registry receipts are separate records.
