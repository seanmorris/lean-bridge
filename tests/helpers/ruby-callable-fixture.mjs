/**
 * Independent additional Ruby callable signatures.
 *
 * @file
 */
import { callableSignatures, callableArities } from "./callable-fixture.mjs";

export const rubyCallableSignatures = [...callableSignatures
...
export const rubyCallableArities = { ...callableArities, "Callables.retainCallback": 1 };
