/**
 * Compile the published Lean definitions and execute the exact Rust example.
 *
 * @file
 */
...
export const rustRecursiveCallableDocumentation = async () => {
	...
	const consumer = (await readFile("docs/consume/rust.md", "utf8")).match(/### Recursive callback values\n[\s\S]*?```rust\n([\s\S]*?)\n```/u)?.[1];
