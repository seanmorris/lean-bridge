 ...
 */
export const probePhpCompounds = async ({ consumer, environment, installed, projection }) => {
	const deployment = join(consumer, "php-native/relocated");
	const source = await readFile("tests/fixtures/compound-consumers/php-faults.php", "utf8");
