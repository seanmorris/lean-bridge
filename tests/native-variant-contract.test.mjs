...
test("unimplemented host projections still reject variants before generation", () => {
	...
	for(const build of [compileCopiedPythonModel, compileCopiedRustModel, compileCopiedDotnetModel, compileCopiedJvmModel, compileCopiedRubyModel, compileCopiedPhpModel, compileCopiedWitModel])
