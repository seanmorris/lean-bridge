...
import { beforeCppStructuredCallables } from "./helpers/cpp-structured-callable-source-history.mjs";
...
test("C structured callable history reverses literal edits while preserving unrelated drift", async () => {
	...
	{
		const source = beforeCppStructuredCallables(update.path, await readFile(update.path, "utf8"));
