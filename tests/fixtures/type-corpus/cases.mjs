...
const cFamilyExpectation = (id, category, profile) => {
	if(["negative-nat", "bad-record"].includes(id)) return { rejectionMessage: profile === "cpp" ? "Nat must be nonnegative" : "Invalid copied value, negative Nat or 16 MiB call limit exceeded" };
