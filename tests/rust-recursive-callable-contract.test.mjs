...
test("Cargo-only recursive callables agree with every selected supported native target", () => {
	...
	for(const targets of [["cargo"], ["cargo", "c"], ["cpp", "cargo"], ["pypi", "cargo"], ["cargo", "rubygems"], ["cargo", "nuget"], ["cargo", "maven"], ["cargo", "php-native"], ["cargo", "c", "cpp", "pypi", "rubygems", "nuget", "maven", "php-native"]])
