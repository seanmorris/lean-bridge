...
test("host projections without compound adapters reject these shapes before generation", () => {
	for(const compile of [compileCopiedPythonModel, compileCopiedRustModel, compileCopiedDotnetModel, compileCopiedJvmModel, compileCopiedRubyModel, compileCopiedPhpModel])
