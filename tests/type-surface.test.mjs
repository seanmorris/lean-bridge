...
test("recursive copied acceptance covers all profiles and npm/C-family/Python/Rust/Ruby/Perl/C#/JVM callback payloads", () => {
	...
	assert.equal(installed.length, 158);
