...
extern lean_object *lean_link_gamma_identity(lean_object *box);
extern uint32_t lean_link_gamma_read(lean_object *box);
extern void bridge_register_lean_gamma(
...
static void lean_link_gamma_register(void) {
  /* Gamma's generated identity/read code has no initialization work. */
  bridge_register_lean_gamma(
