...
test("source intake describes new and existing libraries without widening target capabilities", async () => {
	...
	assert.match(targets, /\[RubyGems\]\(publish\/rubygems\.md\) \| An ordinary Lake project with copied primitives, arrays, records, options, results, products and primitive callables; CLI target `rubygems`/);
