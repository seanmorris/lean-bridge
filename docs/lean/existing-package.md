...
| CPAN resource argument; C, CPAN, PyPI, RubyGems or Cargo callback argument | `"borrow"`, `{ "scope": "call", "anchor": null }` |
| CPAN resource result; C, CPAN, PyPI, RubyGems or Cargo Lean closure result | `"lease"`, `{ "scope": "explicit", "anchor": null }` |
