...
| Native PHP | `supported` | PHP 8.2 NTS on x86-64 Linux with glibc 2.38 or newer through the generated Zend extension | [php-native](php.md#native-php) |
| PHP-Wasm | `supported` | PHP 8.4 in the Node-hosted php-wasm 0.1.0 runtime, lazy and startup profiles | [php-wasm](php.md#php-wasm) |
