...
Native Composer packages accept arrays, Lists, options, results, products,
...
The [installed structured callback checks](evidence/php-structured-callables-20260925.md)
cover weak and strict callers on both source paths. PHP-Wasm structured
callbacks, native recursive callbacks and resource-containing payloads remain
separate work.
