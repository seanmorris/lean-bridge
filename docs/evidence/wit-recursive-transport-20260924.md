...
Prepared-package integration, source-free installation, independent reproduction,
shared-runtime composition and installed acceptance remain open. The public WIT
build target still rejects recursive values. The support inventory remains at
sixteen accepted copied-recursive profiles out of seventeen. Structured callback
and closure payloads, resource-containing aggregates and full cross-language
acceptance remain part of VO1219.
