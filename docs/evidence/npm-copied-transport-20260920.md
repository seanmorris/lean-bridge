...
primitive arrays, and the [compound milestone](npm-compounds-20260920.md) compiles
Option, Except and nested binary products. This record describes the earlier
codec-only milestone.
