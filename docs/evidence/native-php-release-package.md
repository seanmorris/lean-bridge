...
8. install the Composer files, binaries, and metadata; and
...
The test builds the package into two separate temporary roots, enumerates every file, and compares every byte. The comparison covers 32 files, including both native binaries, Composer sources, stubs, documentation, reflection, assurance data, source identities, generator manifests, and release hashes.
