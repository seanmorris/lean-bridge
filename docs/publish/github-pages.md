...
The Pages workflow publishes documentation and runnable examples. It does not execute the npm publisher, obtain `NPM_TOKEN`, or satisfy the [production package-release approvals](production-release.md).
