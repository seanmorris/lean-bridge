...
| Ordinary native `native-release.json` and archive receipts | Runtime, component, Binding IR, and archive identities for C, C++, Perl, NuGet, Maven, RubyGems, WIT, PyPI and Cargo. These are not universal signed transaction receipts. |
