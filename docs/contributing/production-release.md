...
Start with the complete candidate from the [sandbox tutorial](sandbox-release.md#rehearse-a-registry-release), including its authorization, manifest, archives, comparison evidence, and sandbox result. Verify the candidate again before any external write:
